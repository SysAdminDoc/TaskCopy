...
### Changed
- Consolidated planning documentation into root `ROADMAP.md`, `COMPLETED.md`, and `RESEARCH_REPORT.md`; archived the historical research feature plan under `docs/archive/research/`.
